...
diccionario_titulos = fn.crea_diccionario_(lista_libros, 'title')
diccionario_autores = fn.crea_diccionario_(lista_libros, 'author')
diccionario_id = fn.crea_diccionario_(lista_libros, 'id')
...
def busqueda_titulo():
    ...
    if request.method == 'POST':
        ...
        (diccionario_titulos, request.form['titulo'])
        print(resultado)
        print(titulo)
