...
class Pelicula:
    ...
    def to_dict(self):
        ...
        return {'id_pelicula': self.id_pelicula,
                ...
                'fecha_lanzamiento': self.fecha_lanzamiento.strftime('%Y-%m-%d').date(),
...
class SistemaCine:
    ...
    def __init__(self):
        ''' Inicializa la clase con las bases de datos vacías'''
        self.actores = {}
        self.peliculas = {}
        self.relaciones = {}
        self.usuarios = {}
    ...
    def obtener_peliculas_por_actor(self, id_estrella):
        ''' Devuelve una lista de películas en las que ha trabajado un actor'''
...
if __name__ == '__main__':
    ...
    archivo_users = "datos/movies_db - users.csv"
    sistema = SistemaCine()
    ...
    sistema.cargar_csv(archivo_users, User)
